 ...
 * Redy Chasby
 */
class Masalahptg extends CI_Controller
{
    ...
    function __construct(){
        ...
        $this->load->model('Masalahptg_model');
    ...
    public function ajax_list()
    {
        ...
        $list = $this->Masalahptg_model->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        $output = array(
                        "draw" => $_POST['draw'],
                        "recordsTotal" => $this->Masalahptg_model->count_all(),
                        "recordsFiltered" => $this->Masalahptg_model->count_filtered(),
                        "data" => $data,
                );
    ...
    {
        $data = $this->Masalahptg_model->get_by_id($id);
    ...
    public function ajax_add()
    {
        ...
        if(empty($lastcode)){
            ...
            $data = array(
                ...
                $insert = $this->Masalahptg_model->save($data); 
    ...
    public function ajax_update()
    {
        ...
        $data = array(
         ...
         $this->Masalahptg_model->update(array('kode_laporan' => $this->input->post('id')), $data);
        echo json_encode(array("status" => TRUE));
    }
 
    public function ajax_delete($id)
    {
        $this->Masalahptg_model->delete_by_id($id);
        echo json_encode(array("status" => TRUE));
    }
