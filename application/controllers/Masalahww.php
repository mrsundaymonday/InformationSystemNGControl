 ...
 * Redy Chasby
 */
class Masalahww extends CI_Controller
{
    ...
    public function ajax_list()
    {
        ...
        $list = $this->Masalahww_model->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        $output = array(
                        "draw" => $_POST['draw'],
                        "recordsTotal" => $this->Masalahww_model->count_all(),
                        "recordsFiltered" => $this->Masalahww_model->count_filtered(),
                        "data" => $data,
                );
    ...
    {
        $data = $this->Masalahww_model->get_by_id($id);
    ...
    public function ajax_add()
    {
        ...
        if(empty($lastcode)){
            ...
            //    'std_price' => $this->input->post('std_price'),
                ...
                $insert = $this->Masalahww_model->save($data); 
    ...
    public function ajax_update()
    {
        ...
        $data = array(
         ...
         $this->Masalahww_model->update(array('kode_laporan' => $this->input->post('id')), $data);
        echo json_encode(array("status" => TRUE));
    }
 
    public function ajax_delete($id)
    {
        $this->Masalahww_model->delete_by_id($id);
        echo json_encode(array("status" => TRUE));
    }
